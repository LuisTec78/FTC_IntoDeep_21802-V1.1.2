...
public class Mecanum extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        DcMotor motorLu = hardwareMap.get(DcMotor.class,"leftMotorUp");
        //asigna el motor derecho superior
        DcMotor motorRu = hardwareMap.get(DcMotor.class,"rightMotorUp");
        //asigna el motor izquierdo inferior
        DcMotor motorLd = hardwareMap.get(DcMotor.class,"leftMotorDown");
        //asigna el motor derecho inferior
        DcMotor motorRd = hardwareMap.get(DcMotor.class,"rightMotorDown");
        ...
        while (opModeIsActive()){ //corre mientras el programa este activo
            if (gamepad1.y) { //corre si presionas el boton a (X en el control de play)
            ...
            else if (gamepad1.a) { //corre si no se está presionando a pero se presiona b
            ...
            }else if (gamepad1.x) { //corre si no se está presionando a pero se presiona b
                //asigna las potencias a los motores para retroceder
                motorLu.setPower(-0.5);
                motorRu.setPower(0.5);
                motorLd.setPower(0.5);
